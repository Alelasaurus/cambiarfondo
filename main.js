...
var nosee_y=0;
function preload() {
 kakashi=loadImage('https://i.postimg.cc/5y64zw6D/kakashi.png');
 naruto=loadImage('https://i.postimg.cc/CLnrKmFk/naruto.png');
}
...
//fill(0, 249, 189);
//stroke(22, 223, 174 );
image(kakashi,nose_x,nose_y,150,300);
image(naruto,nosee_x,nosee_y,280,300);
}
